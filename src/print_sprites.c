...
static void draw_buttons(var_t m)
{
    ...
    sfRenderWindow_drawSprite(WDW, C_LENS, NULL);
    if (STATE(tool) == 1)
        sfRenderWindow_drawSprite(WDW, C_COLOR1, NULL);
    sfRenderWindow_drawSprite(WDW, C_COLOR2, NULL);
    ...
    sfRenderWindow_drawRectangleShape(WDW, C_RECT2, NULL);
    sfRenderWindow_drawSprite(WDW, C_RECT, NULL);
    sfRenderWindow_drawSprite(WDW, C_CIRCLE, NULL);
    sfRenderWindow_drawSprite(WDW, C_LINE, NULL);
}
