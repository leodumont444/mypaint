...
int init_bounds(var_t m)
{
    ...
    B_LENS = SP_GET_BOUNDS(C_LENS);
    B_PIP = SP_GET_BOUNDS(C_PIP);
    B_COLOR1 = SP_GET_BOUNDS(C_COLOR1);
    B_COLOR2 = SP_GET_BOUNDS(C_COLOR2);
