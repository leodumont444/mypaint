...
static int change_help_visibility(var_t m)
{
    ...
    sfText_setCharacterSize(TXT_ABOUT, 16);
...
{
    S_ABOUT = create_sprite("about.jpg", (V2F){0, 0});
    CHECK_MALLOC(S_ABOUT);
    S_HELP = create_sprite("help_gui.jpg", (V2F){0, 0});
    CHECK_MALLOC(S_HELP);
    ...
    sfText_setCharacterSize(TXT_HELP, 16);
