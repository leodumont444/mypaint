...
#define H_LENS m->gui->hover->lens
#define H_PIP m->gui->hover->pip
#define H_COLOR1 m->gui->hover->color1
#define H_COLOR2 m->gui->hover->color2
...
#define C_LENS m->gui->buttons->lens
#define C_PIP m->gui->buttons->pip
#define C_COLOR1 m->gui->buttons->color1
#define C_COLOR2 m->gui->buttons->color2
...
#define C_RECT2 m->gui->buttons->rect2
...
#define C_LINE m->gui->buttons->line
...
#define B_LENS m->gui->bounds->lens
#define B_PIP m->gui->bounds->pip
#define B_COLOR1 m->gui->bounds->color1
#define B_COLOR2 m->gui->bounds->color2
...
/**
    ...
    * @param av
    * @param env
    * @return SUCCESS (0) or FAILURE (84)
*/
int error_handling(int ac, char **av, char **env);


/**
    * @brief init all the important variables
    * @param m
    * @return SUCCESS (0) or FAILURE (84)
*/
...
/**
 * @brief change the visibility of the tools buttons
 * @param m
*/
...
/**
 * @brief check if the mouse is on the tools buttons
 * @param m
 * @param mousePos
*/
...
/**
 * @brief init the tools buttons
 * @param m
*/
void change_color_visibility(var_t m);

/**
 * @brief check if the mouse is on the buttons, if so display hover sprites
 * @param m
 * @param mousePos
*/
...
/**
 * @brief change the slider when clicked
 * @param m
 * @param mousePos
*/
